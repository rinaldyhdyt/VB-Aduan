...
Public Class dashboard_petugas_adu

    Private Sub dashboard_petugas_adu_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call data()
        Call grid()
        Call id()
        Call id_tug()
            ...
            Try
                ...
                If pilih = Windows.Forms.DialogResult.OK Then
                    ...
                    Try
                        ...
                        Me.Controls.Clear()
                        InitializeComponent()
                        dashboard_petugas_adu_Load(e, e)
                        Refresh()
                    Catch ex As Exception
                        MsgBox(ex.Message)
                    End Try
